...
const ProductDetailSkeleton = () => (
  <div className="container mx-auto px-4 pb-12 animate-pulse">
    <div className="grid grid-cols-1 gap-10 lg:grid-cols-2">
      <div>
        <div className="flex gap-4">
          <div className="flex flex-col gap-3">
            {[0,1,2,3].map(i => <div key={i} className="h-20 w-20 rounded-xl bg-muted/60" />)}
          </div>
          <div className="flex-1 aspect-square rounded-2xl bg-muted/60" />
        </div>
      </div>
...
const ProductDetail = () => {
  ...
  const colors = product.colors?.length > 0 ? product.colors : [{ name: "Default", value: "#888888" }];
  ...
  const reviewCount = product.reviews || (product as any).reviewCount || 0;
        ...
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-2">
          ...
          <div className="flex flex-col">
            ...
            <div className="mt-5 flex items-baseline gap-3">
              ...
              {discount > 0 && <Badge className="bg-primary/10 text-primary border-0 text-xs">Save {discount}%</Badge>}
            </div>
            ...
            <div className="mt-6">
              <p className="text-sm font-semibold text-foreground mb-3">
                Color: <span className="font-normal text-muted-foreground">{colors[selectedColor].name}</span>
              </p>
